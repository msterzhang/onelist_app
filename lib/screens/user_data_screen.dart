...
class _UserDataScreenState extends State<UserDataScreen> with WidgetsBindingObserver {
  ...
  Future<void> loadDate() async {
    ...
    try {
      String api = "/v1/api/${widget.userDataType}/data/list?data_type=$dataType&page=$page&size=$size";
            ...
            child: loading
              ...
              children: <Widget>[
                ...
                Row(
                  children: [
                    Expanded(
                      child: HeaderTitleBar(title: widget.title),
                    ),
                    const SizedBox(
                      width: 20,
                    )
