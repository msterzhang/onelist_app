...
class SeasonItemWidget extends StatefulWidget {
  const SeasonItemWidget({
    Key? key,
  ...
  @override
  State<SeasonItemWidget> createState() => _SeasonItemWidgetState();
}

class _SeasonItemWidgetState extends State<SeasonItemWidget> {
